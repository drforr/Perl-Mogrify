package Perl::Mogrify::Module::Build::Standard;
...
Perl::Mogrify::Module::Build::Standard - Customization of L<Module::Build> for L<Perl::Mogrify> distributions.
...
developing L<Perl::Mogrify>.  The following actions have been added
or redefined:
