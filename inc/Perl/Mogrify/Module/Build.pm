package Perl::Mogrify::Module::Build;
...
use base 'Perl::Mogrify::Module::Build::Standard';
...
Perl::Mogrify::Module::Build - Customization of L<Module::Build> for L<Perl::Mogrify>.


=head1 DESCRIPTION

This is a custom subclass of L<Module::Build> (actually,
L<Perl::Mogrify::Module::Build::Standard>) that enhances existing functionality
and adds more for the benefit of installing and developing L<Perl::Mogrify>.
