package Perl::Mogrify::EnforcerSummaryGenerator;
...
use Perl::Mogrify::Exception::IO ();
use Perl::Mogrify::EnforcerFactory (-test => 1);
use Perl::Mogrify::Utils qw< :characters >;
use Perl::Mogrify::Utils::POD qw< get_module_abstract_from_file >;
...
sub generate_policy_summary {
    ...
    print "\n\nGenerating Perl::Mogrify::EnforcerSummary.\n";
    ...
    my $policy_summary = 'lib/Perl/Mogrify/EnforcerSummary.pod';
...
Perl::Mogrify::EnforcerSummary - Descriptions of the Enforcer modules included with L<Perl::Mogrify|Perl::Mogrify> itself.


=head1 DESCRIPTION

The following Enforcer modules are distributed with Perl::Mogrify. (There are
...
This is part of L<Perl::Mogrify|Perl::Mogrify> version 1.116.
...
Perl::Mogrify::EnforcerSummaryGenerator - Create F<EnforcerSummary.pod> file.


=head1 DESCRIPTION

This module contains subroutines for generating the
L<Perl::Mogrify::EnforcerSummary> POD file.  This file contains a brief
summary of all the Policies that ship with L<Perl::Mogrify>.  These
...
also the C<policysummary> action in L<Perl::Mogrify::Module::Build>.
