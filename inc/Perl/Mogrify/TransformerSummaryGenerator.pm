package Perl::Mogrify::TransformerSummaryGenerator;
...
sub generate_policy_summary {
    ...
    print "\n\nGenerating Perl::Mogrify::TransformerSummary.\n";
...
Perl::Mogrify::TransformerSummary - Descriptions of the Transformer modules included with L<Perl::Mogrify|Perl::Mogrify> itself.


=head1 DESCRIPTION

The following Transformer modules are distributed with Perl::Mogrify. (There are
...
Perl::Mogrify::TransformerSummaryGenerator - Create F<TransformerSummary.pod> file.


=head1 DESCRIPTION

This module contains subroutines for generating the
L<Perl::Mogrify::TransformerSummary> POD file.  This file contains a brief
