package Perl::Mogrify::BuildUtilities;
...
extracted the Perl::Mogrify tarball using GNU tar.
...
Perl::Mogrify::BuildUtilities - Common bits of compiling Perl::Mogrify.


=head1 DESCRIPTION

Various utilities used in assembling Perl::Mogrify, primary for use by
