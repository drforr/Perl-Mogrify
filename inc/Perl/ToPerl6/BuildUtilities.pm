package Perl::ToPerl6::BuildUtilities;
...
extracted the Perl::ToPerl6 tarball using GNU tar.
...
Various utilities used in assembling Perl::ToPerl6, primary for use by
