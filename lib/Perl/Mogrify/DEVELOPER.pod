...
If there are no violations, then the Transformer returns nothing.
...
L<Perl::Mogrify::Transformer/"violation"> method, passing in the
...
L<default_maximum_violations_per_document()|Perl::Mogrify::Transformer/"default_maximum_violations_per_document()">
method to provide a limit.  The user can override this value with a
value for "maximum_violations_per_document" in their F<.perlmogrifyrc>.
