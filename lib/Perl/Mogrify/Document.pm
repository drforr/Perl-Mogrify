...
use Perl::Mogrify::Exception::Parse qw< throw_parse >;
use Perl::Mogrify::Utils qw< :booleans :characters shebang_line >;
...
sub _init_from_external_source { ## no critic (Subroutines::RequireArgUnpacking)
    ...
    if (@_ == 1) {
        warnings::warnif(
            'deprecated',
            'Perl::Mogrify::Document->new($source) deprecated, use Perl::Mogrify::Document->new(-source => $source) instead.' ## no critic (ValuesAndExpressions::RequireInterpolationOfMetachars)
        );
        %args = ('-source' => shift);
    } else {
        %args = @_;
...
sub find {
    ...
    # once per Perl::Mogrify::Document instance.  %elements of will be
...
# This got hung on the Perl::Mogrify::Document, rather than living in
# Perl::Mogrify::Utils::PPI, because of the possibility that caching of scope
...
sub process_annotations {
    ...
    my @annotations = Perl::Mogrify::Annotation->create_annotations($self);
...
Perl::Mogrify::Document - Caching wrapper around a PPI::Document.
...
=head1 SYNOPSIS
    ...
    $doc = Perl::Mogrify::Document->new(-source => $doc);
    ## Then use the instance just like a PPI::Document


=head1 DESCRIPTION

Perl::Mogrify does a lot of iterations over the PPI document tree via
...
L<Perl::Mogrify::Document|Perl::Mogrify::Document> will not have a filename.
This may cause L<Perl::Mogrify::Document|Perl::Mogrify::Document> to incorrectly
...
L<Perl::Mogrify::Document|Perl::Mogrify::Document> to have a particular
...
Perl::Mogrify's subsequent analysis because some caches may fall out of
date.
...
this method will return two L<Perl::Mogrify::Document|Perl::Mogrify::Document>s
...
PPI::Document, the Perl::Mogrify::Document class masquerades as the
PPI::Document class.
...
L<Perl::Mogrify::Annotation|Perl::Mogrify::Annotation>s that
