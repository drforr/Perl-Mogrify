package Perl::Mogrify::EnforcerListing;
...
sub to_string {
    ...
    Perl::Mogrify::Enforcer::set_format( "%s %p [%t]\n" );
...
Perl::Mogrify::EnforcerListing - Display minimal information about Policies.


=head1 DESCRIPTION

This is a helper class that formats a set of Enforcer objects for
...
Returns a reference to a new C<Perl::Mogrify::EnforcerListing> object.
...
Returns a string representation of this C<EnforcerListing>.  See
...
When a L<Perl::Mogrify::EnforcerListing|Perl::Mogrify::EnforcerListing> is
...
the constructor of this C<EnforcerListing>.
