...
use Perl::Mogrify::Utils::PPI qw< is_ppi_expression_or_generic_statement >;
...
sub is_script {
    ...
    return $doc->is_program()
        if blessed($doc) && $doc->isa('Perl::Mogrify::Document');
...
sub all_perl_files {
    ...
    # poached from Test::Perl::Mogrify.
...
# subroutine was also poached from Test::Perl::Mogrify
...
Perl::Mogrify::Utils - General utility subroutines and constants for Perl::Mogrify and derivative distributions.
...
should use the L<Perl::Mogrify::Document/"is_program()"> method instead.
...
parameters to a C<use Perl::Mogrify::Util> statement.
...
See also L<Perl::Mogrify::Utils::PPI|Perl::Mogrify::Utils::PPI>.
...
L<Perl::Mogrify::Utils::Constants|Perl::Mogrify::Utils::Constants>,
L<Perl::Mogrify::Utils::McCabe|Perl::Mogrify::Utils::McCabe>,
L<Perl::Mogrify::Utils::PPI|Perl::Mogrify::Utils::PPI>,
