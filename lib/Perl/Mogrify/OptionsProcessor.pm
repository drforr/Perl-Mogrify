package Perl::Mogrify::OptionsProcessor;
...
use Perl::Mogrify::Exception::Configuration::Option::Global::ExtraParameter;
    ...
    if ( my @remaining = sort keys %args ){
        ...
        foreach my $option_name (@remaining) {
            $errors->add_exception(
                Perl::Mogrify::Exception::Configuration::Option::Global::ExtraParameter->new(
...
Perl::Mogrify::OptionsProcessor - The global configuration default values, combined with command-line values.


=head1 DESCRIPTION

This is a helper class that encapsulates the default parameters for
constructing a L<Perl::Mogrify::Config|Perl::Mogrify::Config> object.
...
Returns a reference to a new C<Perl::Mogrify::OptionsProcessor> object.
...
L<Perl::Mogrify::Config|Perl::Mogrify::Config>,
