package Perl::Mogrify::Transformer;
...
use Perl::Mogrify::Exception::Configuration::Option::Transformer::ExtraParameter;
use Perl::Mogrify::Exception::Configuration::Option::Transformer::ParameterValue;
...
sub new {
    ...
    if ( $class->can('supported_parameters') ) {
        ...
        @parameters =
            map
                { Perl::Mogrify::TransformerParameter->new($_) }
...
sub new_parameter_value_exception {
    ...
    return Perl::Mogrify::Exception::Configuration::Option::Transformer::ParameterValue->new(
...
Perl::Mogrify::Transformer - Base class for all Transformer modules.


=head1 DESCRIPTION

Perl::Mogrify::Transformer is the abstract base class for all Transformer
...
L<Perl::Mogrify::TransformerConfig|Perl::Mogrify::TransformerConfig> as a
...
Create a
L<Perl::Mogrify::Exception::Configuration::Option::Transformer::ParameterValue|Perl::Mogrify::Exception::Configuration::Option::Transformer::ParameterValue>
...
Return the name of this policy without the "Perl::Mogrify::Transformer::"
prefix.
...
method returns C<$SEVERITY_LOWEST>.  Authors of Perl::Mogrify::Transformer
...
Perl::Mogrify::Transformer objects can call this method to assign a
...
L<Perl::Mogrify::TransformerParameter|Perl::Mogrify::TransformerParameter>.
...
Name of the Transformer without the C<Perl::Mogrify::Transformer::> prefix.
...
string for L<Perl::Mogrify::TransformerParameter/"to_formatted_string">.
