package Perl::Mogrify::EnforcerParameter;
...
use Perl::Mogrify::EnforcerParameter::Behavior;
use Perl::Mogrify::EnforcerParameter::Behavior::Boolean;
use Perl::Mogrify::EnforcerParameter::Behavior::Enumeration;
use Perl::Mogrify::EnforcerParameter::Behavior::Integer;
use Perl::Mogrify::EnforcerParameter::Behavior::String;
use Perl::Mogrify::EnforcerParameter::Behavior::StringList;
...
Readonly::Hash my %BEHAVIORS =>
    (
        'boolean'     => Perl::Mogrify::EnforcerParameter::Behavior::Boolean->new(),
        'enumeration' => Perl::Mogrify::EnforcerParameter::Behavior::Enumeration->new(),
        'integer'     => Perl::Mogrify::EnforcerParameter::Behavior::Integer->new(),
        'string'      => Perl::Mogrify::EnforcerParameter::Behavior::String->new(),
        'string list' => Perl::Mogrify::EnforcerParameter::Behavior::StringList->new(),
    );
...
Perl::Mogrify::EnforcerParameter - Metadata about a parameter for a Enforcer.
