package Perl::Mogrify::Statistics;
...
use Perl::Mogrify::Utils::McCabe qw{ calculate_mccabe_of_sub };
...
Create a new instance of Perl::Mogrify::Statistics.  No arguments are supported
at this time.
...
The total number of subroutines analyzed by this Mogrify.


=item C<statements()>

The total number of statements analyzed by this Mogrify.


=item C<lines()>

The total number of lines of code analyzed by this Mogrify.


=item C<lines_of_blank()>

The total number of blank lines analyzed by this Mogrify. This includes only
blank lines in code, not POD or data.


=item C<lines_of_comment()>

The total number of comment lines analyzed by this Mogrify. This includes only
lines whose first non-whitespace character is C<#>.


=item C<lines_of_data()>

The total number of lines of data section analyzed by this Mogrify, not
...
The total number of lines of Perl code analyzed by this Mogrify. Perl appearing
in the data section is not counted.


=item C<lines_of_pod()>

The total number of lines of POD analyzed by this Mogrify. Pod occurring in a
