package Perl::Mogrify::EnforcerParameter::Behavior::String;
...
Perl::Mogrify::EnforcerParameter::Behavior::String - Actions appropriate for a simple string parameter.
