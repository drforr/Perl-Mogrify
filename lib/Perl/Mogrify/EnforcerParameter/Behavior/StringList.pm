package Perl::Mogrify::EnforcerParameter::Behavior::StringList;
...
Perl::Mogrify::EnforcerParameter::Behavior::StringList - Actions appropriate for a parameter that is a list of strings.
