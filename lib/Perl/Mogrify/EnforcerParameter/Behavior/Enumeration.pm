package Perl::Mogrify::EnforcerParameter::Behavior::Enumeration;
...
use base qw{ Perl::Mogrify::EnforcerParameter::Behavior };
...
Perl::Mogrify::EnforcerParameter::Behavior::Enumeration - Actions appropriate for an enumerated value.


=head1 DESCRIPTION

Provides a standard set of functionality for an enumerated
L<Perl::Mogrify::EnforcerParameter|Perl::Mogrify::EnforcerParameter> so that
