package Perl::Mogrify::Enforcer::ControlStructures::ProhibitCascadingIfElse;
...
Perl::Mogrify::Enforcer::ControlStructures::ProhibitCascadingIfElse - Don't write long "if-elsif-elsif-elsif-elsif...else" chains.
