package Perl::Mogrify::Enforcer::ControlStructures::ProhibitNegativeExpressionsInUnlessAndUntilConditions;
...
use Perl::Mogrify::Utils qw< :characters :severities :classification hashify >;
...
Perl::Mogrify::Enforcer::ControlStructures::ProhibitNegativeExpressionsInUnlessAndUntilConditions - Don't use operators like C<not>, C<!~>, and C<le> within C<until> and C<unless>.
...
L<Perl::Mogrify::Enforcer::ControlStructures::ProhibitUnlessBlocks|Perl::Mogrify::Enforcer::ControlStructures::ProhibitUnlessBlocks>
