package Perl::Mogrify::Enforcer::ControlStructures::ProhibitUntilBlocks;
...
Perl::Mogrify::Enforcer::ControlStructures::ProhibitUntilBlocks - Write C<while(! $condition)> instead of C<until($condition)>.
...
This Enforcer only covers the block-form of C<until>.  For the postfix
