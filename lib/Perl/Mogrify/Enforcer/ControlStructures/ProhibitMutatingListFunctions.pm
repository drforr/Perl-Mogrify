package Perl::Mogrify::Enforcer::ControlStructures::ProhibitMutatingListFunctions;
...
Perl::Mogrify::Enforcer::ControlStructures::ProhibitMutatingListFunctions - Don't modify C<$_> in list functions.
