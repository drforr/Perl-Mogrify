package Perl::Mogrify::Enforcer::ControlStructures::ProhibitCStyleForLoops;
...
Perl::Mogrify::Enforcer::ControlStructures::ProhibitCStyleForLoops - Write C<for(0..20)> instead of C<for($i=0; $i<=20; $i++)>.
