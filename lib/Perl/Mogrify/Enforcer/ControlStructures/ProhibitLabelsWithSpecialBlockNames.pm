package Perl::Mogrify::Enforcer::ControlStructures::ProhibitLabelsWithSpecialBlockNames;
...
use Perl::Mogrify::Utils qw{ :severities hashify };
...
Perl::Mogrify::Enforcer::ControlStructures::ProhibitLabelsWithSpecialBlockNames - Don't use labels that are the same as the special block names.
