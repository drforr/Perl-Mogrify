package Perl::Mogrify::Enforcer::ControlStructures::ProhibitPostfixControls;
...
use Perl::Mogrify::Utils qw{ :characters :severities :data_conversion :classification };
...
Perl::Mogrify::Enforcer::ControlStructures::ProhibitPostfixControls - Write C<if($condition){ do_something() }> instead of C<do_something() if $condition>.
...
flow-controls just like C<next> or C<last>.  So this Enforcer does
