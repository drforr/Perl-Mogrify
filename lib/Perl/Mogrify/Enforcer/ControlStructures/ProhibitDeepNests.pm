package Perl::Mogrify::Enforcer::ControlStructures::ProhibitDeepNests;
...
Perl::Mogrify::Enforcer::ControlStructures::ProhibitDeepNests - Don't write deeply nested loops and conditionals.
