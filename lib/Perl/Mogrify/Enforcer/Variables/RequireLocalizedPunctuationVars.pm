package Perl::Mogrify::Enforcer::Variables::RequireLocalizedPunctuationVars;
...
use Perl::Mogrify::Utils qw{ :severities :classification $EMPTY hashify};
...
Perl::Mogrify::Enforcer::Variables::RequireLocalizedPunctuationVars - Magic variables should be assigned as "local".
