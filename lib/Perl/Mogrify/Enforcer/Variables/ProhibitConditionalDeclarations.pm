package Perl::Mogrify::Enforcer::Variables::ProhibitConditionalDeclarations;
...
Perl::Mogrify::Enforcer::Variables::ProhibitConditionalDeclarations - Do not write C< my $foo = $bar if $baz; >.
