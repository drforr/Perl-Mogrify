package Perl::Mogrify::Enforcer::Variables::RequireInitializationForLocalVars;
...
Perl::Mogrify::Enforcer::Variables::RequireInitializationForLocalVars - Write C<local $foo = $bar;> instead of just C<local $foo;>.
