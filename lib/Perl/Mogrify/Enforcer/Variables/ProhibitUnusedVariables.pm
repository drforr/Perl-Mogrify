package Perl::Mogrify::Enforcer::Variables::ProhibitUnusedVariables;
...
Perl::Mogrify::Enforcer::Variables::ProhibitUnusedVariables - Don't ask for storage you don't need.
...
At present, this Enforcer is very limited in order to ensure that there
...
aren't the same variable, this Enforcer won't complain.
