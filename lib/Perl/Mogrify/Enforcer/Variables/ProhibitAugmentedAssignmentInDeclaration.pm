package Perl::Mogrify::Enforcer::Variables::ProhibitAugmentedAssignmentInDeclaration;
...
Perl::Mogrify::Enforcer::Variables::ProhibitAugmentedAssignmentInDeclaration - Do not write C< my $foo .= 'bar'; >.
