package Perl::Mogrify::Enforcer::Variables::ProhibitMatchVars;
...
use Perl::Mogrify::Utils qw{ :severities :data_conversion };
...
Perl::Mogrify::Enforcer::Variables::ProhibitMatchVars - Avoid C<$`>, C<$&>, C<$'> and their English equivalents.
...
L<Perl::Mogrify::Enforcer::Modules::RequireNoMatchVarsWithUseEnglish|Perl::Mogrify::Enforcer::Modules::RequireNoMatchVarsWithUseEnglish>,
