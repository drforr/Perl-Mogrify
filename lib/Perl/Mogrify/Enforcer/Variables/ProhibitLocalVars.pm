package Perl::Mogrify::Enforcer::Variables::ProhibitLocalVars;
...
use Perl::Mogrify::Utils qw{ :severities :classification };
...
Perl::Mogrify::Enforcer::Variables::ProhibitLocalVars - Use C<my> instead of C<local>, except when you have to.
...
Perl::Mogrify will not complain if you C<local>-ize variables with a
