package Perl::Mogrify::Enforcer::Variables::ProtectPrivateVars;
...
Perl::Mogrify::Enforcer::Variables::ProtectPrivateVars - Prevent access to private vars in other packages.
