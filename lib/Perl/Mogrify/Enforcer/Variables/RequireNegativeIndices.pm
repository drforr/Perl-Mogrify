package Perl::Mogrify::Enforcer::Variables::RequireNegativeIndices;
...
Perl::Mogrify::Enforcer::Variables::RequireNegativeIndices - Negative array index should be used.
