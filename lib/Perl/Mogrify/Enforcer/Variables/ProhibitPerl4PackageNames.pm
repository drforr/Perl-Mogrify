package Perl::Mogrify::Enforcer::Variables::ProhibitPerl4PackageNames;
...
Perl::Mogrify::Enforcer::Variables::ProhibitPerl4PackageNames - Use double colon (::) to separate package name components instead of single quotes (').
