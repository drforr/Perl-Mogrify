package Perl::Mogrify::Enforcer::Variables::ProhibitPunctuationVars;
...
sub _create_magic_detector {
    ...
    # way Perl::Mogrify handles testing.
    #
...
Perl::Mogrify::Enforcer::Variables::ProhibitPunctuationVars - Write C<$EVAL_ERROR> instead of C<$@>.
