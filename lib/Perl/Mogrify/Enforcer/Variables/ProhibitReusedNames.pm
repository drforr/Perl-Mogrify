package Perl::Mogrify::Enforcer::Variables::ProhibitReusedNames;
...
Perl::Mogrify::Enforcer::Variables::ProhibitReusedNames - Do not reuse a variable name in a lexical scope
