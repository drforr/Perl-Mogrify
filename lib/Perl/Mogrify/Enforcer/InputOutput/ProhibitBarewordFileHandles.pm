package Perl::Mogrify::Enforcer::InputOutput::ProhibitBarewordFileHandles;
...
Perl::Mogrify::Enforcer::InputOutput::ProhibitBarewordFileHandles - Write C<open my $fh, q{<}, $filename;> instead of C<open FH, q{<}, $filename;>.
