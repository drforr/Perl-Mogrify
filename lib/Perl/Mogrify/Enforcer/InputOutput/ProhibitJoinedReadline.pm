package Perl::Mogrify::Enforcer::InputOutput::ProhibitJoinedReadline;
...
use Perl::Mogrify::Utils qw{ :severities :classification parse_arg_list };
...
Perl::Mogrify::Enforcer::InputOutput::ProhibitJoinedReadline - Use C<local $/ = undef> or L<File::Slurp|File::Slurp> instead of joined readline.
