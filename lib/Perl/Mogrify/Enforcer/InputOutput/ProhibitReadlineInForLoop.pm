package Perl::Mogrify::Enforcer::InputOutput::ProhibitReadlineInForLoop;
...
Perl::Mogrify::Enforcer::InputOutput::ProhibitReadlineInForLoop - Write C<< while( $line = <> ){...} >> instead of C<< for(<>){...} >>.
