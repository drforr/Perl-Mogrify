package Perl::Mogrify::Enforcer::InputOutput::ProhibitTwoArgOpen;
...
Perl::Mogrify::Enforcer::InputOutput::ProhibitTwoArgOpen - Write C<< open $fh, q{<}, $filename; >> instead of C<< open $fh, "<$filename"; >>.
