package Perl::Mogrify::Enforcer::InputOutput::RequireCheckedClose;
...
Perl::Mogrify::Enforcer::InputOutput::RequireCheckedClose - Write C<< my $error = close $fh; >> instead of C<< close $fh; >>.
