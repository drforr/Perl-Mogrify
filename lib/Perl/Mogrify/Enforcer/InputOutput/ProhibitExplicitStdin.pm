package Perl::Mogrify::Enforcer::InputOutput::ProhibitExplicitStdin;
...
Perl::Mogrify::Enforcer::InputOutput::ProhibitExplicitStdin - Use "<>" or "<ARGV>" or a prompting module instead of "<STDIN>".
