package Perl::Mogrify::Enforcer::InputOutput::ProhibitBacktickOperators;
...
use Perl::Mogrify::Utils qw{ :severities is_in_void_context };
...
Perl::Mogrify::Enforcer::InputOutput::ProhibitBacktickOperators - Discourage stuff like C<@files = `ls $directory`>.
