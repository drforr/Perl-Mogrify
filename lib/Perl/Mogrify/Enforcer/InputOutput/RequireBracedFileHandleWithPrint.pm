package Perl::Mogrify::Enforcer::InputOutput::RequireBracedFileHandleWithPrint;
...
use Perl::Mogrify::Utils qw{ :severities :classification :data_conversion };
...
Perl::Mogrify::Enforcer::InputOutput::RequireBracedFileHandleWithPrint - Write C<print {$FH} $foo, $bar;> instead of C<print $FH $foo, $bar;>.
