package Perl::Mogrify::Enforcer::InputOutput::RequireCheckedSyscalls;
...
Perl::Mogrify::Enforcer::InputOutput::RequireCheckedSyscalls - Return value of flagged function ignored.
