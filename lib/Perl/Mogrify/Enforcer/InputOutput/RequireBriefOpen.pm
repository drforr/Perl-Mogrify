package Perl::Mogrify::Enforcer::InputOutput::RequireBriefOpen;
...
use Perl::Mogrify::Utils qw{ :severities :classification :booleans
...
Perl::Mogrify::Enforcer::InputOutput::RequireBriefOpen - Close filehandles as soon as possible after opening them.
