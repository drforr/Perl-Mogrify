package Perl::Mogrify::Enforcer::InputOutput::RequireEncodingWithUTF8Layer;
...
use Perl::Mogrify::Utils qw{ :severities :ppi };
...
Perl::Mogrify::Enforcer::InputOutput::RequireEncodingWithUTF8Layer - Write C<< open $fh, q{<:encoding(UTF-8)}, $filename; >> instead of C<< open $fh, q{{<:utf8}, $filename; >>.
...
Because C<Perl::Mogrify> does a static analysis, this policy can not
detect cases like
