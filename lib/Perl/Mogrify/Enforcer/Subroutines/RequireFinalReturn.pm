package Perl::Mogrify::Enforcer::Subroutines::RequireFinalReturn;
...
Perl::Mogrify::Enforcer::Subroutines::RequireFinalReturn - End every path through a subroutine with an explicit C<return> statement.
...
Be careful when fixing problems identified by this Enforcer; don't
...
or C<exit>, then you can configure Perl::Mogrify to recognize those
