package Perl::Mogrify::Enforcer::Subroutines::ProhibitExcessComplexity;
...
use Perl::Mogrify::Utils qw{ :severities :data_conversion :classification };
...
Perl::Mogrify::Enforcer::Subroutines::ProhibitExcessComplexity - Minimize complexity by factoring code into smaller subroutines.
...
possible paths through a subroutine.  This Enforcer approximates the
