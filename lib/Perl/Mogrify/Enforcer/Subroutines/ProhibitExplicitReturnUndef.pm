package Perl::Mogrify::Enforcer::Subroutines::ProhibitExplicitReturnUndef;
...
Perl::Mogrify::Enforcer::Subroutines::ProhibitExplicitReturnUndef - Return failure with bare C<return> instead of C<return undef>.
