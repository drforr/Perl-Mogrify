package Perl::Mogrify::Enforcer::Subroutines::ProhibitNestedSubs;
...
Perl::Mogrify::Enforcer::Subroutines::ProhibitNestedSubs - C<sub never { sub correct {} }>.
...
Originally part of L<Perl::Mogrify::Tics|Perl::Mogrify::Tics>.
