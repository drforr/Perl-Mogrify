package Perl::Mogrify::Enforcer::Subroutines::ProhibitUnusedPrivateSubroutines;
...
Perl::Mogrify::Enforcer::Subroutines::ProhibitUnusedPrivateSubroutines - Prevent unused private subroutines.
...
a double underscore are not considered to be private.  (Perl::Mogrify,
...
other Perl::Mogrify modules, but not by anything outside of
Perl::Mogrify.)
...
L<Perl::Mogrify::Enforcer::Subroutines::ProtectPrivateSubs|Perl::Mogrify::Enforcer::Subroutines::ProtectPrivateSubs>,
