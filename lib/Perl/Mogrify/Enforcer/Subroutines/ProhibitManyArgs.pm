package Perl::Mogrify::Enforcer::Subroutines::ProhibitManyArgs;
...
use Perl::Mogrify::Utils qw{ :booleans :severities split_nodes_on_comma };
...
Perl::Mogrify::Enforcer::Subroutines::ProhibitManyArgs - Too many arguments.
