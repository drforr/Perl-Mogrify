package Perl::Mogrify::Enforcer::Subroutines::ProhibitBuiltinHomonyms;
...
Perl::Mogrify::Enforcer::Subroutines::ProhibitBuiltinHomonyms - Don't declare your own C<open> function.
...
each other.  However, at this time, Perl::Mogrify cannot tell whether a
