package Perl::Mogrify::Enforcer::Subroutines::ProhibitSubroutinePrototypes;
...
Perl::Mogrify::Enforcer::Subroutines::ProhibitSubroutinePrototypes - Don't write C<sub my_function (@@) {}>.
