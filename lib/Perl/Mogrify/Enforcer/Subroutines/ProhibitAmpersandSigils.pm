package Perl::Mogrify::Enforcer::Subroutines::ProhibitAmpersandSigils;
...
Perl::Mogrify::Enforcer::Subroutines::ProhibitAmpersandSigils - Don't call functions with a leading ampersand sigil.
