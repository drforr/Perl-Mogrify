package Perl::Mogrify::Enforcer::TestingAndDebugging::RequireTestLabels;
...
sub _has_test_more {
    ...
    # search for method calls.  Since Perl::Mogrify::Document is
...
Perl::Mogrify::Enforcer::TestingAndDebugging::RequireTestLabels - Tests should all have labels.
