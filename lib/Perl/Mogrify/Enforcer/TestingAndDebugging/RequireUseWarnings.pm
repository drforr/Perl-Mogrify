package Perl::Mogrify::Enforcer::TestingAndDebugging::RequireUseWarnings;
...
use Perl::Mogrify::Utils qw{ :severities $EMPTY };
use Perl::Mogrify::Utils::Constants qw{ :equivalent_modules };
...
#-----------------------------------------------------------------------------
# Here, we're using the fact that Perl::Mogrify::Document::find() is optimized
...
Perl::Mogrify::Enforcer::TestingAndDebugging::RequireUseWarnings - Always C<use warnings>.
...
L<Perl::Mogrify::Enforcer::TestingAndDebugging::ProhibitNoWarnings|Perl::Mogrify::Enforcer::TestingAndDebugging::ProhibitNoWarnings>
