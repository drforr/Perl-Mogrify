package Perl::Mogrify::Enforcer::CodeLayout::ProhibitParensWithBuiltins;
...
Perl::Mogrify::Enforcer::CodeLayout::ProhibitParensWithBuiltins - Write C<open $handle, $path> instead of C<open($handle, $path)>.
