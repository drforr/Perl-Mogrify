package Perl::Mogrify::Enforcer::CodeLayout::ProhibitHardTabs;
...
Perl::Mogrify::Enforcer::CodeLayout::ProhibitHardTabs - Use spaces instead of tabs.
...
This Enforcer catches all tabs in your source code, including POD,
...
Beware that Perl::Mogrify may report the location of the string that
