package Perl::Mogrify::Enforcer::CodeLayout::ProhibitQuotedWordLists;
...
use Perl::Mogrify::Utils qw{ :characters :severities :classification};
...
Perl::Mogrify::Enforcer::CodeLayout::ProhibitQuotedWordLists - Write C<qw(foo bar baz)> instead of C<('foo', 'bar', 'baz')>.
...
I've tried to make this Enforcer smart by targeting only "lists" that
