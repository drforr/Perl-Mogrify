package Perl::Mogrify::Enforcer::CodeLayout::RequireConsistentNewlines;
...
Perl::Mogrify::Enforcer::CodeLayout::RequireConsistentNewlines - Use the same newline through the source.
