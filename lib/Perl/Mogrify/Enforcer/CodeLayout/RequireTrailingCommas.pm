package Perl::Mogrify::Enforcer::CodeLayout::RequireTrailingCommas;
...
Perl::Mogrify::Enforcer::CodeLayout::RequireTrailingCommas - Put a comma at the end of every multi-line list declaration, including the last one.
