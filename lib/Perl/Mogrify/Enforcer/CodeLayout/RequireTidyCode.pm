package Perl::Mogrify::Enforcer::CodeLayout::RequireTidyCode;
...
Perl::Mogrify::Enforcer::CodeLayout::RequireTidyCode - Must run code through L<perltidy|perltidy>.
...
Perl::Mogrify can be told to tell Perl::Tidy to use a specific
