package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitInterpolationOfLiterals;
...
use Perl::Mogrify::Utils qw{ :characters :severities :data_conversion };
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitInterpolationOfLiterals - Always use single quotes for literal strings.
...
those strings are literal, Perl::Mogrify will complain.  To prevent
...
L<Perl::Mogrify::Enforcer::ValuesAndExpressions::RequireInterpolationOfMetachars|Perl::Mogrify::Enforcer::ValuesAndExpressions::RequireInterpolationOfMetachars>
