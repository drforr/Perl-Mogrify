package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitConstantPragma;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitConstantPragma - Don't C<< use constant FOO => 15 >>.
