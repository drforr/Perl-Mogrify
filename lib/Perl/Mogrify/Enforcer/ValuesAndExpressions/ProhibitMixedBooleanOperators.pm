package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitMixedBooleanOperators;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitMixedBooleanOperators - Write C< !$foo && $bar || $baz > instead of C< not $foo && $bar or $baz>.
