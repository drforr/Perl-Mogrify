package Perl::Mogrify::Enforcer::ValuesAndExpressions::RequireQuotedHeredocTerminator;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::RequireQuotedHeredocTerminator - Write C< print <<'THE_END' > or C< print <<"THE_END" >.
