package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitQuotesAsQuotelikeOperatorDelimiters;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitQuotesAsQuotelikeOperatorDelimiters - Don't use quotes (C<'>, C<">, C<`>) as delimiters for the quote-like operators.
