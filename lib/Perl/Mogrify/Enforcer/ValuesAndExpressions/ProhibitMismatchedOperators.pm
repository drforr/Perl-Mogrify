package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitMismatchedOperators;
use 5.006001;
use strict;
use warnings;
use Readonly;

use Perl::Mogrify::Utils qw{ :booleans :severities };
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitMismatchedOperators - Don't mix numeric operators with string operands, or vice-versa.
...
warns you about using mismatched operators at run-time.  This Enforcer
