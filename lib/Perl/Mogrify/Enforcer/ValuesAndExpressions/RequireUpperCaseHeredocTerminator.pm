package Perl::Mogrify::Enforcer::ValuesAndExpressions::RequireUpperCaseHeredocTerminator;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::RequireUpperCaseHeredocTerminator - Write C< <<'THE_END'; > instead of C< <<'theEnd'; >.
