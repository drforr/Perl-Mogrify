package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitComplexVersion;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitComplexVersion - Prohibit version values from outside the module.
