package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitCommaSeparatedStatements;
...
use Perl::Mogrify::Utils::PPI qw{ is_ppi_statement_subclass };
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitCommaSeparatedStatements - Don't use the comma operator as a statement separator.
