package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitVersionStrings;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitVersionStrings - Don't use strings like C<v1.4> or C<1.4.5> when including other modules.
