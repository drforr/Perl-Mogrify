package Perl::Mogrify::Enforcer::ValuesAndExpressions::RequireConstantVersion;
...
sub violates {
    ...
    return $value if $value->isa( 'Perl::Mogrify::Exception' );
...
# Perl::Mogrify::Exception to be returned.
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::RequireConstantVersion - Require $VERSION to be a constant rather than a computed value.
...
L<Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitVersionStrings|Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitVersionStrings>.
