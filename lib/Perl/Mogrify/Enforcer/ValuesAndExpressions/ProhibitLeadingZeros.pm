package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitLeadingZeros;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitLeadingZeros - Write C<oct(755)> instead of C<0755>.
