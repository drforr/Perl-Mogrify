package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitMagicNumbers;
...
use Perl::Mogrify::Utils qw{ :booleans :characters :severities :data_conversion };
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitMagicNumbers - Don't use values that don't explain themselves.
