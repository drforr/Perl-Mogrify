package Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitEscapedCharacters;
...
Perl::Mogrify::Enforcer::ValuesAndExpressions::ProhibitEscapedCharacters - Write C<"\N{DELETE}"> instead of C<"\x7F">, etc.
