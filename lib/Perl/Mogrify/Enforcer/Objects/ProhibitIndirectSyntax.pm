package Perl::Mogrify::Enforcer::Objects::ProhibitIndirectSyntax;
...
Perl::Mogrify::Enforcer::Objects::ProhibitIndirectSyntax - Prohibit indirect object call syntax.
...
Indirect object syntax is also hard for Perl::Mogrify to disambiguate, so this
...
L<Perl::Mogrify::Enforcer::Dynamic::NoIndirect|Perl::Mogrify::Enforcer::Dynamic::NoIndirect>
