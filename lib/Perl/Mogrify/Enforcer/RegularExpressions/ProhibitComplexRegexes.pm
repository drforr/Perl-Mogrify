package Perl::Mogrify::Enforcer::RegularExpressions::ProhibitComplexRegexes;
...
Perl::Mogrify::Enforcer::RegularExpressions::ProhibitComplexRegexes - Split long regexps into smaller C<qr//> chunks.
