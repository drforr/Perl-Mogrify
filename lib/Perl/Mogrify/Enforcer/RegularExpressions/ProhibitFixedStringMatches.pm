package Perl::Mogrify::Enforcer::RegularExpressions::ProhibitFixedStringMatches;
...
Perl::Mogrify::Enforcer::RegularExpressions::ProhibitFixedStringMatches - Use C<eq> or hash instead of fixed-pattern regexps.
