package Perl::Mogrify::Enforcer::RegularExpressions::RequireBracesForMultiline;
...
Perl::Mogrify::Enforcer::RegularExpressions::RequireBracesForMultiline - Use C<{> and C<}> to delimit multi-line regexps.
