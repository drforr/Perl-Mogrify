package Perl::Mogrify::Enforcer::RegularExpressions::ProhibitEnumeratedClasses;
...
Perl::Mogrify::Enforcer::RegularExpressions::ProhibitEnumeratedClasses - Use named character classes instead of explicit character lists.
