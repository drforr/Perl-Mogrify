package Perl::Mogrify::Enforcer::RegularExpressions::ProhibitUnusualDelimiters;
...
Perl::Mogrify::Enforcer::RegularExpressions::ProhibitUnusualDelimiters - Use only C<//> or C<{}> to delimit regexps.
