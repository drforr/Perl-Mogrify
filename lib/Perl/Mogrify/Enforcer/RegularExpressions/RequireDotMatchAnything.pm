package Perl::Mogrify::Enforcer::RegularExpressions::RequireDotMatchAnything;
...
Perl::Mogrify::Enforcer::RegularExpressions::RequireDotMatchAnything - Always use the C</s> modifier with regular expressions.
