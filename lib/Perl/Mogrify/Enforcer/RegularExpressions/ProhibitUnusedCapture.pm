package Perl::Mogrify::Enforcer::RegularExpressions::ProhibitUnusedCapture;
...
#           '!~' operator;
#       document => a reference to the Perl::Mogrify::Document;
...
Perl::Mogrify::Enforcer::RegularExpressions::ProhibitUnusedCapture - Only use a capturing group if you plan to use the captured value.
