package Perl::Mogrify::Enforcer::RegularExpressions::RequireLineBoundaryMatching;
...
Perl::Mogrify::Enforcer::RegularExpressions::RequireLineBoundaryMatching - Always use the C</m> modifier with regular expressions.
