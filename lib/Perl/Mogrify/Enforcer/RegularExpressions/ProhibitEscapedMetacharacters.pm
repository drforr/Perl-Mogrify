package Perl::Mogrify::Enforcer::RegularExpressions::ProhibitEscapedMetacharacters;
...
use Perl::Mogrify::Utils qw{ :booleans :severities hashify };
...
Perl::Mogrify::Enforcer::RegularExpressions::ProhibitEscapedMetacharacters - Use character classes for literal meta-characters instead of escapes.
