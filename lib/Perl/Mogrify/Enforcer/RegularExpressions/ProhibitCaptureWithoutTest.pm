package Perl::Mogrify::Enforcer::RegularExpressions::ProhibitCaptureWithoutTest;
...
use Perl::Mogrify::Utils qw{ :booleans :data_conversion :severities };
...
Perl::Mogrify::Enforcer::RegularExpressions::ProhibitCaptureWithoutTest - Capture variable used outside conditional.
