package Perl::Mogrify::Enforcer::RegularExpressions::RequireExtendedFormatting;
...
Perl::Mogrify::Enforcer::RegularExpressions::RequireExtendedFormatting - Always use the C</x> modifier with regular expressions.
