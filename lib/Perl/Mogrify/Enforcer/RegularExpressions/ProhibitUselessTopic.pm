package Perl::Mogrify::Enforcer::RegularExpressions::ProhibitUselessTopic;
...
Perl::Mogrify::Enforcer::RegularExpressions::ProhibitUselessTopic - Don't use $_ to match against regexes.
