package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUniversalIsa;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUniversalIsa - Write C<< eval { $foo->isa($pkg) } >> instead of C<UNIVERSAL::isa($foo, $pkg)>.
...
L<Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUniversalCan|Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUniversalCan>
