package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitComplexMappings;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitComplexMappings - Map blocks should have a single statement.
