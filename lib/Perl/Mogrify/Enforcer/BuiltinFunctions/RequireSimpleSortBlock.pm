package Perl::Mogrify::Enforcer::BuiltinFunctions::RequireSimpleSortBlock;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::RequireSimpleSortBlock - Sort blocks should have a single statement.
