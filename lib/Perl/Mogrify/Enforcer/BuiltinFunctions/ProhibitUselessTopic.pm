package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUselessTopic;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUselessTopic - Don't pass $_ to built-in functions that assume it, or to most filetest operators.

=head1 AFFILIATION

This Enforcer is part of the L<Perl::Mogrify|Perl::Mogrify> distribution.
