package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUniversalCan;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUniversalCan - Write C<< eval { $foo->can($name) } >> instead of C<UNIVERSAL::can($foo, $name)>.
...
L<Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUniversalIsa|Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitUniversalIsa>
