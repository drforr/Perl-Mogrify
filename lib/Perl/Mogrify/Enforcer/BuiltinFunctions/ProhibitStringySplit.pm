package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitStringySplit;
...
use Perl::Mogrify::Utils qw{ :characters :severities :classification :ppi };
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitStringySplit - Write C<split /-/, $string> instead of C<split '-', $string>.
...
behavior, so Perl::Mogrify forgives that usage.  See C<"perldoc -f
