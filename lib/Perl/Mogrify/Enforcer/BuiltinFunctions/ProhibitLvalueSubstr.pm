package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitLvalueSubstr;
...
use Perl::Mogrify::Utils qw{ :severities :classification :language };
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitLvalueSubstr - Use 4-argument C<substr> instead of writing C<substr($foo, 2, 6) = $bar>.
