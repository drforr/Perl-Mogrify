package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitBooleanGrep;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitBooleanGrep - Use C<List::MoreUtils::any> instead of C<grep> in boolean context.
