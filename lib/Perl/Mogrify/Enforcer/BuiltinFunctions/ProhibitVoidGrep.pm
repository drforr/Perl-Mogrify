package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitVoidGrep;
...
use Perl::Mogrify::Utils qw{ :severities :classification is_in_void_context };
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitVoidGrep - Don't use C<grep> in void contexts.
