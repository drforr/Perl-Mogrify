package Perl::Mogrify::Enforcer::BuiltinFunctions::RequireBlockGrep;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::RequireBlockGrep - Write C<grep { /$pattern/ } @list> instead of C<grep /$pattern/, @list>.
...
L<Perl::Mogrify::Enforcer::BuiltinFunctions::RequireBlockMap|Perl::Mogrify::Enforcer::BuiltinFunctions::RequireBlockMap>
