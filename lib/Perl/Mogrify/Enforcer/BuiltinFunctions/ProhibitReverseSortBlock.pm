package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitReverseSortBlock;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitReverseSortBlock - Forbid $b before $a in sort blocks.
