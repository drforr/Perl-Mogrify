package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitStringyEval;
...
use Perl::Mogrify::Utils qw{ :booleans :severities :classification :ppi $SCOLON };
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitStringyEval - Write C<eval { my $foo; bar($foo) }> instead of C<eval "my $foo; bar($foo);">.
...
There is an C<allow_includes> boolean option for this Enforcer.  If set, then
...
L<Perl::Mogrify::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval|Perl::Mogrify::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval>.

This option inspired by Ricardo SIGNES'
L<Perl::Mogrify::Enforcer::Lax::ProhibitStringyEval::ExceptForRequire|Perl::Mogrify::Enforcer::Lax::ProhibitStringyEval::ExceptForRequire>.


=head1 SEE ALSO

L<Perl::Mogrify::Enforcer::ControlStrucutres::RequireBlockGrep|Perl::Mogrify::Enforcer::ControlStrucutres::RequireBlockGrep>

L<Perl::Mogrify::Enforcer::ControlStrucutres::RequireBlockMap|Perl::Mogrify::Enforcer::ControlStrucutres::RequireBlockMap>
