package Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitSleepViaSelect;
...
Perl::Mogrify::Enforcer::BuiltinFunctions::ProhibitSleepViaSelect - Use L<Time::HiRes|Time::HiRes> instead of something like C<select(undef, undef, undef, .05)>.
