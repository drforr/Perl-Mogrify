package Perl::Mogrify::Enforcer::Modules::ProhibitExcessMainComplexity;
...
use Perl::Mogrify::Utils::McCabe qw{ calculate_mccabe_of_main };
...
Perl::Mogrify::Enforcer::Modules::ProhibitExcessMainComplexity - Minimize complexity in code that is B<outside> of subroutines.
...
possible paths through a block of code.  This Enforcer approximates the
...
Whereas
L<Perl::Mogrify::Enforcer::Subroutines::ProhibitExcessComplexity|Perl::Mogrify::Enforcer::Subroutines::ProhibitExcessComplexity>
scores the complexity of each subroutine, this Enforcer scores the total
...
McCabe score higher than this number, it will generate a Enforcer violation.
...
number.  So don't get offended if your code triggers this Enforcer.
