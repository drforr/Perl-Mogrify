package Perl::Mogrify::Enforcer::Modules::RequireFilenameMatchesPackage;
...
Perl::Mogrify::Enforcer::Modules::RequireFilenameMatchesPackage - Package declaration must match filename.
...
Therefore, this Enforcer requires the last component of the first package name
...
If the file is not deemed to be a module, then this Enforcer does not apply.
