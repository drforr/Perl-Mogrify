package Perl::Mogrify::Enforcer::Modules::RequireNoMatchVarsWithUseEnglish;
...
Perl::Mogrify::Enforcer::Modules::RequireNoMatchVarsWithUseEnglish - C<use English> must be passed a C<-no_match_vars> argument.
