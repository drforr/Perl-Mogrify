package Perl::Mogrify::Enforcer::Modules::RequireEndWithOne;
...
Perl::Mogrify::Enforcer::Modules::RequireEndWithOne - End each module with an explicitly C<1;> instead of some funky expression.
...
L<Perl::Mogrify::Enforcer::Modules::RequireExplicitPackage|Perl::Mogrify::Enforcer::Modules::RequireExplicitPackage>.
