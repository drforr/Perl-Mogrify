package Perl::Mogrify::Enforcer::Modules::ProhibitEvilModules;
...
Perl::Mogrify::Enforcer::Modules::ProhibitEvilModules - Ban modules that aren't blessed by your shop.
