package Perl::Mogrify::Enforcer::Modules::RequireBarewordIncludes;
...
Perl::Mogrify::Enforcer::Modules::RequireBarewordIncludes - Write C<require Module> instead of C<require 'Module.pm'>.
...
is expressed as a bareword.  So as a side-effect, this Enforcer
...
This Enforcer is a replacement for C<ProhibitRequireStatements>, which
...
(L<Perl::Mogrify|Perl::Mogrify> is an example of this).  In that case,
...
correct motivation for and behavior of this Enforcer.  Thanks Chris.
