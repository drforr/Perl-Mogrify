package Perl::Mogrify::Enforcer::Modules::ProhibitAutomaticExportation;
...
Perl::Mogrify::Enforcer::Modules::ProhibitAutomaticExportation - Export symbols via C<@EXPORT_OK> or C<%EXPORT_TAGS> instead of C<@EXPORT>.
