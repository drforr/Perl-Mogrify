package Perl::Mogrify::Enforcer::Modules::RequireExplicitPackage;
...
use Perl::Mogrify::Utils qw{ :booleans :severities :classification };
...
Perl::Mogrify::Enforcer::Modules::RequireExplicitPackage - Always make the C<package> explicit.
...
C<main>, so this Enforcer doesn't apply to files that begin with a perl
