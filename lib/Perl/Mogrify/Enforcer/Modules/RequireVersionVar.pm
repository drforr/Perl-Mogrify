package Perl::Mogrify::Enforcer::Modules::RequireVersionVar;
...
Perl::Mogrify::Enforcer::Modules::RequireVersionVar - Give every module a C<$VERSION> number.
...
This Enforcer scans your file for any package variable named
...
or 'v-strings.'  However, this Enforcer only insists that the
