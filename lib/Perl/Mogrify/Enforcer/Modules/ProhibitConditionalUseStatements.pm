package Perl::Mogrify::Enforcer::Modules::ProhibitConditionalUseStatements;
...
Perl::Mogrify::Enforcer::Modules::ProhibitConditionalUseStatements - Avoid putting conditional logic around compile-time includes.
