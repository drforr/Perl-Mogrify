package Perl::Mogrify::Enforcer::Modules::ProhibitMultiplePackages;
...
Perl::Mogrify::Enforcer::Modules::ProhibitMultiplePackages - Put packages (especially subclasses) in separate files.
