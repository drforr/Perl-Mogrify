package Perl::Mogrify::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval;
...
use Perl::Mogrify::Utils qw< :booleans :characters :severities hashify
    precedence_of >;
...
sub _is_in_correct_position_in_a_condition_or_foreach_loop_collection {
    ...
    while ($parent) {
        ...
        # into Perl::Mogrify::Utils::*, but I don't have time to sort out
...
Perl::Mogrify::Enforcer::ErrorHandling::RequireCheckingReturnValueOfEval - You can't depend upon the value of C<$@>/C<$EVAL_ERROR> to tell whether an C<eval> failed.
