package Perl::Mogrify::Enforcer::ErrorHandling::RequireCarping;
...
Perl::Mogrify::Enforcer::ErrorHandling::RequireCarping - Use functions from L<Carp|Carp> instead of C<warn> or C<die>.
