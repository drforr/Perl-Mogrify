package Perl::Mogrify::Enforcer::NamingConventions::Capitalization;
...
>;
use Perl::Mogrify::Utils::Perl qw< symbol_without_sigil >;
...
Readonly::Hash my %CAPITALIZATION_SCHEME_TAGS    => (
    ...
    ':no_restriction'       => {
        ...
        regex_violation     => 'there is a bug in Perl::Mogrify if you are reading this',
    },
);
...
sub _derive_capitalization_test_regex_and_message {
    ...
    if ( my $tag_properties = $CAPITALIZATION_SCHEME_TAGS{$capitalization} ) {
        ...
        $configuration_exceptions->add_exception(
            Perl::Mogrify::Exception::Configuration::Option::Enforcer::ParameterValue->new(
                policy          => $self,
...
Perl::Mogrify::Enforcer::NamingConventions::Capitalization - Distinguish different program components by case.
