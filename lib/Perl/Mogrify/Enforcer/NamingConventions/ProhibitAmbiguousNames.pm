package Perl::Mogrify::Enforcer::NamingConventions::ProhibitAmbiguousNames;
...
Perl::Mogrify::Enforcer::NamingConventions::ProhibitAmbiguousNames - Don't use vague variable or subroutine names like 'last' or 'record'.
