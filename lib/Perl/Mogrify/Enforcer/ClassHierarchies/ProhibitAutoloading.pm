package Perl::Mogrify::Enforcer::ClassHierarchies::ProhibitAutoloading;
...
Perl::Mogrify::Enforcer::ClassHierarchies::ProhibitAutoloading - AUTOLOAD methods should be avoided.
...
Enforcer.  The C<AUTOLOAD> mechanism is an easy way to generate methods
