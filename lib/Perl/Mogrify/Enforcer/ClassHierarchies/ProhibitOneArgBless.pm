package Perl::Mogrify::Enforcer::ClassHierarchies::ProhibitOneArgBless;
...
use Perl::Mogrify::Utils qw{ :booleans :severities :classification :ppi };
...
Perl::Mogrify::Enforcer::ClassHierarchies::ProhibitOneArgBless - Write C<bless {}, $class;> instead of just C<bless {};>.
