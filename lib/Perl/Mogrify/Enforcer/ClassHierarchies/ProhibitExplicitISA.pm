package Perl::Mogrify::Enforcer::ClassHierarchies::ProhibitExplicitISA;
...
Perl::Mogrify::Enforcer::ClassHierarchies::ProhibitExplicitISA - Employ C<use base> instead of C<@ISA>.
