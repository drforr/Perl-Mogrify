package Perl::Mogrify::Enforcer::Miscellanea::ProhibitUnrestrictedNoEnforcer;
...
use Perl::Mogrify::Utils qw<:severities :booleans>;
...
Perl::Mogrify::Enforcer::Miscellanea::ProhibitUnrestrictedNoEnforcer - Forbid a bare C<## no critic>
...
Unfortunately, L<Perl::Mogrify|Perl::Mogrify> is very sloppy about
...
In all of these cases, Perl::Mogrify will silently disable B<all> Policies,
rather than just the ones you requested.  But if you use the
C<ProhibitUnrestrictedNoEnforcer> Enforcer, all of these will generate
...
been using the syntax that is shown throughout the Perl::Mogrify
