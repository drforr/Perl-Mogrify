package Perl::Mogrify::Enforcer::Documentation::RequirePodSections;
...
use Perl::Mogrify::Utils qw{ :booleans :characters :severities :classification };
...
Perl::Mogrify::Enforcer::Documentation::RequirePodSections - Organize your POD into the customary sections.
...
This Enforcer requires your POD to contain certain C<=head1> sections.
If the file doesn't contain any POD at all, then this Enforcer does not
...
Currently, this Enforcer does not look for the required POD sections
