package Perl::Mogrify::Enforcer::Documentation::RequirePackageMatchesPodName;
...
Perl::Mogrify::Enforcer::Documentation::RequirePackageMatchesPodName - The C<=head1 NAME> section should match the package.
