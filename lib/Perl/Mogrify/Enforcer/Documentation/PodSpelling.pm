package Perl::Mogrify::Enforcer::Documentation::PodSpelling;
...
sub _run_spell_command {
    ...
    eval {
        ...
        or do {
            ...
            if (
                    $EVAL_ERROR
                and not ref Perl::Mogrify::Exception::Fatal::Generic->caught()
            ) {
...
Perl::Mogrify::Enforcer::Documentation::PodSpelling - Check your spelling.
...
Ideally, we'd like Perl::Mogrify to tell you when your documentation is
...
A spell checking program is not included with Perl::Mogrify.
