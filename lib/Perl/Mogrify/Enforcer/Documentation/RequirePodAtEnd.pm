package Perl::Mogrify::Enforcer::Documentation::RequirePodAtEnd;
...
Perl::Mogrify::Enforcer::Documentation::RequirePodAtEnd - All POD should be after C<__END__>.
...
aren't usually part of the documentation, this Enforcer does allows them
