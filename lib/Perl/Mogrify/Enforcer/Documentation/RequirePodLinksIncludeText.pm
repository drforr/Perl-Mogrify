package Perl::Mogrify::Enforcer::Documentation::RequirePodLinksIncludeText;
...
use Perl::Mogrify::Utils::POD::ParseInteriorSequence;
...
=cut
    ...
    my $parser = Perl::Mogrify::Utils::POD::ParseInteriorSequence->new();
...
Perl::Mogrify::Enforcer::Documentation::RequirePodLinksIncludeText - Provide text to display with your pod links.
...
This Enforcer requires your POD links to contain text to override your POD
...
LE<lt>Foo/bar> >>, or C<< LE<lt>/bar> >>) are exempt from this Enforcer.


=head1 CONFIGURATION

This Enforcer has two boolean options to configure the handling of links that
