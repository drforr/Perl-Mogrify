package Perl::Mogrify::Enforcer::References::ProhibitDoubleSigils;
...
Perl::Mogrify::Enforcer::References::ProhibitDoubleSigils - Write C<@{ $array_ref }> instead of C<@$array_ref>.
