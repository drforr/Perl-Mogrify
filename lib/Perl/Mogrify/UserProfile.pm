package Perl::Mogrify::UserProfile;
...
use Perl::Mogrify::OptionsProcessor qw();
...
sub _set_options_processor {
    ...
    $self->{_options_processor} =
        Perl::Mogrify::OptionsProcessor->new( %{ $defaults } );
    return $self;
}
...
L<Perl::Mogrify::Config|Perl::Mogrify::Config> does that.
