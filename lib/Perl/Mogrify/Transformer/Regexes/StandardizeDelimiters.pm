package Perl::Mogrify::Transformer::Regexes::StandardizeDelimiters;
...
Perl::Mogrify::Transformer::Regexp::StandardizeDelimiters - Regexen can no longer have alphanumeric delimiters
