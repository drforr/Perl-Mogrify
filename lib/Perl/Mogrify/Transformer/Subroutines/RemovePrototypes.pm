package Perl::Mogrify::Transformer::Subroutines::RemovePrototypes;
...
Perl::Mogrify::Transformer::Subroutines::RemovePrototypes - Remove ($)-style prototypes on subroutines.
