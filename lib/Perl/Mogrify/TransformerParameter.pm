package Perl::Mogrify::TransformerParameter;
...
use Perl::Mogrify::TransformerParameter::Behavior;
use Perl::Mogrify::TransformerParameter::Behavior::Boolean;
use Perl::Mogrify::TransformerParameter::Behavior::Enumeration;
use Perl::Mogrify::TransformerParameter::Behavior::Integer;
use Perl::Mogrify::TransformerParameter::Behavior::String;
use Perl::Mogrify::TransformerParameter::Behavior::StringList;
...
Readonly::Hash my %BEHAVIORS =>
    (
        'boolean'     => Perl::Mogrify::TransformerParameter::Behavior::Boolean->new(),
        'enumeration' => Perl::Mogrify::TransformerParameter::Behavior::Enumeration->new(),
        'integer'     => Perl::Mogrify::TransformerParameter::Behavior::Integer->new(),
        'string'      => Perl::Mogrify::TransformerParameter::Behavior::String->new(),
        'string list' => Perl::Mogrify::TransformerParameter::Behavior::StringList->new(),
    );
...
Perl::Mogrify::TransformerParameter - Metadata about a parameter for a Transformer.
...
would appear if it was specified in a F<.perlmogrifyrc> file.
...
L<Perl::Mogrify::DEVELOPER/"MAKING YOUR POLICY CONFIGURABLE">
