package Perl::Mogrify::TestUtils;
...
# t/tlib/Perl/Mogrify/TestUtilitiesWithMinimalDependencies.pm.
...
Perl::Mogrify::TestUtils - Utility functions for testing new Policies.
