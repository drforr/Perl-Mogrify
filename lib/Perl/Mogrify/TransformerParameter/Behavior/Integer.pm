package Perl::Mogrify::TransformerParameter::Behavior::Integer;
...
Perl::Mogrify::TransformerParameter::Behavior::Integer - Actions appropriate for an integer parameter.
