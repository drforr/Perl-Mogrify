package Perl::Mogrify::TransformerParameter::Behavior::StringList;

use 5.006001;
use strict;
use warnings;

use Perl::Mogrify::Utils qw{ :characters &words_from_string &hashify };
...
sub initialize_parameter {
    ...
    $parameter->_set_parser(
        sub {
            ...
            my ($policy, $parameter, $config_string) = @_;  ## no mogrify(Variables::ProhibitReusedNames)
...
Perl::Mogrify::TransformerParameter::Behavior::StringList - Actions appropriate for a parameter that is a list of strings.


=head1 DESCRIPTION

Provides a standard set of functionality for a string list
L<Perl::Mogrify::TransformerParameter|Perl::Mogrify::TransformerParameter> so that
