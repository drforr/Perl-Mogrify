package Perl::Mogrify::TransformerParameter::Behavior::Enumeration;
...
Perl::Mogrify::TransformerParameter::Behavior::Enumeration - Actions appropriate for an enumerated value.
