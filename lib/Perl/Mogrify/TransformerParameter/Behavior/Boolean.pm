package Perl::Mogrify::TransformerParameter::Behavior::Boolean;
...
Perl::Mogrify::TransformerParameter::Behavior::Boolean - Actions appropriate for a boolean parameter.
