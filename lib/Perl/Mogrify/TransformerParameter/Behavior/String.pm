package Perl::Mogrify::TransformerParameter::Behavior::String;
...
Perl::Mogrify::TransformerParameter::Behavior::String - Actions appropriate for a simple string parameter.
