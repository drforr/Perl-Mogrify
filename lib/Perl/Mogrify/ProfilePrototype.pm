package Perl::Mogrify::ProfilePrototype;
...
sub new {
    ...
    if (not $configuration) {
        $configuration = Perl::Mogrify::Config->new(-profile => $EMPTY);
    }
...
Perl::Mogrify::ProfilePrototype - Generate an initial Perl::Mogrify profile.
