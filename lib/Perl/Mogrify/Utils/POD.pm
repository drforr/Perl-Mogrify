package Perl::Mogrify::Utils::POD;
...
use Perl::Mogrify::Exception::IO qw< throw_io >;
...
Perl::Mogrify::Utils::POD - Utility functions for dealing with POD.


=head1 SYNOPSIS

    use Perl::Mogrify::Utils::POD qw< get_pod_section_from_file >;

    my $synopsis =
        get_pod_section_from_file('Perl/Mogrify/Utils/POD.pm', 'SYNOPSIS');
    ...
    my $module_abstract =
        get_module_abstract_from_file('Perl/Mogrify/Utils/POD.pm');
...
Throws a L<Perl::Mogrify::Exception::IO|Perl::Mogrify::Exception::IO> if
...
Throws a
L<Perl::Mogrify::Exception::Generic|Perl::Mogrify::Exception::Generic>
...
L<Perl::Mogrify::Exception::Fatal::Generic|Perl::Mogrify::Exception::Fatal::Generic>.
