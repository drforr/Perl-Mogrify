package Perl::Mogrify::Utils::McCabe;
...
use Perl::Mogrify::Utils qw{ :data_conversion :classification };
...
sub _count_main_logic_operators_and_keywords {
    ...
    # I can't leverage Perl::Mogrify::Document's fast search mechanism here
...
sub _count_logic_keywords {
    ...
    # that I can take advantage of Perl::Mogrify::Document's faster
...
Perl::Mogrify::Utils::McCabe - Functions that calculate the McCabe score of source code.
