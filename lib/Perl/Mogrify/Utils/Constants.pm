package Perl::Mogrify::Utils::Constants;
...
use Perl::Mogrify::Utils qw{ $EMPTY hashify };
...
# inc/Perl/Mogrify/BuildUtilities.pm, sub recommended_module_versions().
...
Perl::Mogrify::Utils::Constants - Global constants.

=head1 DESCRIPTION

Defines commonly used constants for L<Perl::Mogrify|Perl::Mogrify>.
