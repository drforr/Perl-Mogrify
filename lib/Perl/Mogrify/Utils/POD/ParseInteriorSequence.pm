package Perl::Mogrify::Utils::POD::ParseInteriorSequence;
...
Perl::Mogrify::Utils::POD::ParseInteriorSequence - Pod::Parser subclass to find all interior sequences.
...
This module is considered to be private to Perl::Mogrify. It can be
