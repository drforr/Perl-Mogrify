package Perl::Mogrify::Utils::DataConversion;
...
use Perl::Mogrify::Utils qw{ :characters :booleans };
...
Perl::Mogrify::Utils::DataConversion - Utilities for converting from one type of data to another.
