package Perl::Mogrify::Exception::Fatal::Generic;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Fatal::Generic' => {
...
Perl::Mogrify::Exception::Fatal::Generic - A problem for which there is no specialized information.
