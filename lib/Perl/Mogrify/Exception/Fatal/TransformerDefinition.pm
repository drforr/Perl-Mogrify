package Perl::Mogrify::Exception::Fatal::TransformerDefinition;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Fatal::TransformerDefinition' => {
...
Perl::Mogrify::Exception::Fatal::TransformerDefinition - A bug in a policy.
