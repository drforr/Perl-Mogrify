package Perl::Mogrify::Exception::Fatal::EnforcerDefinition;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Fatal::EnforcerDefinition' => {
...
Perl::Mogrify::Exception::Fatal::EnforcerDefinition - A bug in a policy.
