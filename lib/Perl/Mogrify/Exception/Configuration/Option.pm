package Perl::Mogrify::Exception::Configuration::Option;
...
use Perl::Mogrify::Exception::Fatal::Internal;

use Exception::Class (   # this must come after "use P::C::Exception::*"
    'Perl::Mogrify::Exception::Configuration::Option' => {
        isa         => 'Perl::Mogrify::Exception::Configuration',
        description => 'A problem with an option in the Perl::Mogrify configuration, whether from a file or a command line or some other source.',
...
Perl::Mogrify::Exception::Configuration::Option - A problem with an option in the L<Perl::Mogrify|Perl::Mogrify> configuration.
