package Perl::Mogrify::Exception::Configuration::Option::Transformer::ExtraParameter;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Configuration::Option::Transformer::ExtraParameter' => {
        isa         => 'Perl::Mogrify::Exception::Configuration::Option::Transformer',
...
Perl::Mogrify::Exception::Configuration::Option::Transformer::ExtraParameter - The configuration referred to a non-existent parameter for a policy.
