package Perl::Mogrify::Exception::Configuration::Option::Transformer::ParameterValue;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Configuration::Option::Transformer::ParameterValue' => {
...
Perl::Mogrify::Exception::Configuration::Option::Transformer::ParameterValue - A problem with the value of a parameter for a policy.
