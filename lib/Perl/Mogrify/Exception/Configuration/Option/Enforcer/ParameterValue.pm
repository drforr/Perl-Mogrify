package Perl::Mogrify::Exception::Configuration::Option::Enforcer::ParameterValue;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Configuration::Option::Enforcer::ParameterValue' => {
...
Perl::Mogrify::Exception::Configuration::Option::Enforcer::ParameterValue - A problem with the value of a parameter for a policy.

=head1 DESCRIPTION

A representation of a problem found with the value of a parameter for
a L<Perl::Mogrify::Enforcer|Perl::Mogrify::Enforcer>, whether from a
