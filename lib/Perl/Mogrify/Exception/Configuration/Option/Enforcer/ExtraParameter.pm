package Perl::Mogrify::Exception::Configuration::Option::Enforcer::ExtraParameter;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Configuration::Option::Enforcer::ExtraParameter' => {
        isa         => 'Perl::Mogrify::Exception::Configuration::Option::Enforcer',
...
Perl::Mogrify::Exception::Configuration::Option::Enforcer::ExtraParameter - The configuration referred to a non-existent parameter for a policy.

=head1 DESCRIPTION

A representation of the configuration attempting to specify a value
for a parameter that a L<Perl::Mogrify::Enforcer|Perl::Mogrify::Enforcer>
