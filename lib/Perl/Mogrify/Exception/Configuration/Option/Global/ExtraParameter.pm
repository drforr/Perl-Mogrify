package Perl::Mogrify::Exception::Configuration::Option::Global::ExtraParameter;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Configuration::Option::Global::ExtraParameter' => {
        isa         => 'Perl::Mogrify::Exception::Configuration::Option::Global',
...
Perl::Mogrify::Exception::Configuration::Option::Global::ExtraParameter - The configuration referred to a non-existent global option.
