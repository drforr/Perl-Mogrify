package Perl::Mogrify::Exception::Configuration::Option::Global::ParameterValue;
...
Perl::Mogrify::Exception::Configuration::Option::Global::ParameterValue - A problem with the value of a global parameter.
