package Perl::Mogrify::Exception::Configuration::Generic;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Configuration::Generic' => {
        isa         => 'Perl::Mogrify::Exception::Configuration',
        description =>
            q{A problem with Perl::Mogrify configuration that isn't related to an option.},
        alias       => 'throw_generic',
    },
);
...
Perl::Mogrify::Exception::Configuration::Generic - A problem with L<Perl::Mogrify|Perl::Mogrify> configuration that doesn't involve an option.
