package Perl::Mogrify::Exception::Configuration::NonExistentTransformer;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Configuration::NonExistentTransformer' => {
...
Perl::Mogrify::Exception::Configuration::NonExistentTransformer - The configuration referred to a non-existent policy.
