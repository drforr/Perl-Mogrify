package Perl::Mogrify::Exception::Configuration::NonExistentEnforcer;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Configuration::NonExistentEnforcer' => {
...
Perl::Mogrify::Exception::Configuration::NonExistentEnforcer - The configuration referred to a non-existent policy.

=head1 DESCRIPTION

A representation of the configuration attempting to specify a
L<Perl::Mogrify::Enforcer|Perl::Mogrify::Enforcer> that is not known, whether from a
