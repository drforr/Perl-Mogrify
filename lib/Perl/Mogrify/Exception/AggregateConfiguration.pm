package Perl::Mogrify::Exception::AggregateConfiguration;
...
sub add_exception_or_rethrow {
    ...
    if ( $eval_error->isa('Perl::Mogrify::Exception::Configuration') ) {
        $self->add_exception($eval_error);
    }
    elsif (
        $eval_error->isa('Perl::Mogrify::Exception::AggregateConfiguration')
    ) {
...
Perl::Mogrify::Exception::AggregateConfiguration - A collection of a set of problems found in the configuration and/or command-line options.
...
L<Perl::Mogrify::Exception::Configuration|Perl::Mogrify::Exception::Configuration>
or
L<Perl::Mogrify::Exception::AggregateConfiguration|Perl::Mogrify::Exception::AggregateConfiguration>,
