package Perl::Mogrify::Exception::Fatal;
...
use Exception::Class (
    'Perl::Mogrify::Exception::Fatal' => {
        isa         => 'Perl::Mogrify::Exception',
        description =>
            'A problem that should cause Perl::Mogrify to stop running.',
    },
);
...
Perl::Mogrify::Exception::Fatal - A problem that should cause L<Perl::Mogrify|Perl::Mogrify> to stop running.
