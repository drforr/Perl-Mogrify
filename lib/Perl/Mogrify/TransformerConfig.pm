package Perl::Mogrify::TransformerConfig;
...
sub handle_extra_parameters {
    ...
    foreach my $offered_param ( $self->get_parameter_names() ) {
        $parameter_errors->add_exception(
            Perl::Mogrify::Exception::Configuration::Option::Transformer::ExtraParameter->new(
...
Perl::Mogrify::TransformerConfig - Configuration data for a Transformer.
