package Perl::ToPerl6::TransformerParameter;
...
use Perl::ToPerl6::TransformerParameter::Behavior::Integer;
use Perl::ToPerl6::TransformerParameter::Behavior::String;
use Perl::ToPerl6::TransformerParameter::Behavior::StringList;
...
Readonly::Hash my %BEHAVIORS =>
    (
        'boolean'     => Perl::ToPerl6::TransformerParameter::Behavior::Boolean->new(),
        'enumeration' => Perl::ToPerl6::TransformerParameter::Behavior::Enumeration->new(),
        'integer'     => Perl::ToPerl6::TransformerParameter::Behavior::Integer->new(),
        'string'      => Perl::ToPerl6::TransformerParameter::Behavior::String->new(),
        'string list' => Perl::ToPerl6::TransformerParameter::Behavior::StringList->new(),
    );
...
Perl::ToPerl6::TransformerParameter - Metadata about a parameter for a Transformer.
