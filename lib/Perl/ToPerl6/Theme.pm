...
use Perl::ToPerl6::Utils qw{ :characters :data_conversion };
...
Perl::ToPerl6::Theme - Construct thematic sets of transformers.
...
Returns a reference to a new Perl::ToPerl6::Theme object.  C<-rule> is
...
See L<Perl::ToPerl6/"CONFIGURATION"> for more information about
