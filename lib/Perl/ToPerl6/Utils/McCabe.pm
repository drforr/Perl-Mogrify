package Perl::ToPerl6::Utils::McCabe;
...
use Perl::ToPerl6::Utils qw{ :data_conversion :classification };
...
sub _count_main_logic_operators_and_keywords {
    ...
    # I can't leverage Perl::ToPerl6::Document's fast search mechanism here
...
sub _count_logic_keywords {
    ...
    # that I can take advantage of Perl::ToPerl6::Document's faster
...
Perl::ToPerl6::Utils::McCabe - Functions that calculate the McCabe score of source code.
