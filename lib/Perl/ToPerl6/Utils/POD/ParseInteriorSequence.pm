package Perl::ToPerl6::Utils::POD::ParseInteriorSequence;
...
Perl::ToPerl6::Utils::POD::ParseInteriorSequence - Pod::Parser subclass to find all interior sequences.


=head1 SYNOPSIS

    use Perl::ToPerl6::Utils::POD::ParseInteriorSequence;

    my $parser = Perl::ToPerl6::Utils::POD::ParseInteriorSequence->new();
...
This module is considered to be private to Perl::ToPerl6. It can be
