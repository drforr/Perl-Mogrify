package Perl::ToPerl6::Utils::POD;
...
use Perl::ToPerl6::Exception::IO qw< throw_io >;
...
=head1 SYNOPSIS
    ...
    use Perl::ToPerl6::Utils::POD qw< get_pod_section_from_file >;

    my $synopsis =
        get_pod_section_from_file('Perl/ToPerl6/Utils/POD.pm', 'SYNOPSIS');
    ...
    my $module_abstract =
        get_module_abstract_from_file('Perl/ToPerl6/Utils/POD.pm');
...
Throws a L<Perl::ToPerl6::Exception::IO|Perl::ToPerl6::Exception::IO> if
...
Throws a
L<Perl::ToPerl6::Exception::Generic|Perl::ToPerl6::Exception::Generic>
...
L<Perl::ToPerl6::Exception::Fatal::Generic|Perl::ToPerl6::Exception::Fatal::Generic>.
