package Perl::ToPerl6::Utils::Constants;
...
use Perl::ToPerl6::Utils qw{ $EMPTY hashify };
...
Perl::ToPerl6::Utils::Constants - Global constants.

=head1 DESCRIPTION

Defines commonly used constants for L<Perl::ToPerl6|Perl::ToPerl6>.
