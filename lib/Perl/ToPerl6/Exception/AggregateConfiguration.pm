package Perl::ToPerl6::Exception::AggregateConfiguration;
...
sub add_exception_or_rethrow {
    ...
    if ( $eval_error->isa('Perl::ToPerl6::Exception::Configuration') ) {
        $self->add_exception($eval_error);
    }
    elsif (
        $eval_error->isa('Perl::ToPerl6::Exception::AggregateConfiguration')
    ) {
...
Perl::ToPerl6::Exception::AggregateConfiguration - A collection of a set of problems found in the configuration and/or command-line options.
...
L<Perl::ToPerl6::Exception::Configuration|Perl::ToPerl6::Exception::Configuration>
or
L<Perl::ToPerl6::Exception::AggregateConfiguration|Perl::ToPerl6::Exception::AggregateConfiguration>,
