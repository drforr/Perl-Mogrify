...
use Perl::ToPerl6::Utils::PPI qw< is_ppi_expression_or_generic_statement >;
...
sub is_script {
    ...
    warnings::warnif(
        'deprecated',
        'Perl::ToPerl6::Utils::is_script($doc) deprecated, use $doc->is_program() instead.',
    );

    return $doc->is_program()
        if blessed($doc) && $doc->isa('Perl::ToPerl6::Document');
...
sub all_perl_files {
    ...
    # poached from Test::Perl::ToPerl6.
...
# subroutine was also poached from Test::Perl::ToPerl6
...
Perl::ToPerl6::Utils - General utility subroutines and constants for Perl::ToPerl6 and derivative distributions.


=head1 DESCRIPTION

This module provides several static subs and variables that are useful
for developing L<Perl::ToPerl6::Transformer|Perl::ToPerl6::Transformer>
...
should use the L<Perl::ToPerl6::Document/"is_program()"> method instead.
...
L<Perl::ToPerl6::Transformation|Perl::ToPerl6::Transformation>.  See the
...
parameters to a C<use Perl::ToPerl6::Util> statement.
...
See also L<Perl::ToPerl6::Utils::PPI|Perl::ToPerl6::Utils::PPI>.
