package Perl::ToPerl6::TransformerParameter::Behavior::StringList;
...
Perl::ToPerl6::TransformerParameter::Behavior::StringList - Actions appropriate for a parameter that is a list of strings.
