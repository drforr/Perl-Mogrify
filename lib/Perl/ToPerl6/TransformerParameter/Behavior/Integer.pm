package Perl::ToPerl6::TransformerParameter::Behavior::Integer;
...
Perl::ToPerl6::TransformerParameter::Behavior::Integer - Actions appropriate for an integer parameter.
