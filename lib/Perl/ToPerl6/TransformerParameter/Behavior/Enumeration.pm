package Perl::ToPerl6::TransformerParameter::Behavior::Enumeration;
...
Perl::ToPerl6::TransformerParameter::Behavior::Enumeration - Actions appropriate for an enumerated value.
