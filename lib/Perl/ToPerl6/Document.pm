...
use Perl::ToPerl6::Exception::Parse qw< throw_parse >;
use Perl::ToPerl6::Utils qw< :booleans :characters shebang_line >;
...
sub _init_from_external_source {
    ...
    if (@_ == 1) {
        warnings::warnif(
            'deprecated',
            'Perl::ToPerl6::Document->new($source) deprecated, use Perl::ToPerl6::Document->new(-source => $source) instead.'
        );
        %args = ('-source' => shift);
    } else {
        %args = @_;
...
sub find {
    ...
    # once per Perl::ToPerl6::Document instance.  %elements of will be
...
# This got hung on the Perl::ToPerl6::Document, rather than living in
# Perl::ToPerl6::Utils::PPI, because of the possibility that caching of scope
...
sub process_annotations {
    ...
    my @annotations = Perl::ToPerl6::Annotation->create_annotations($self);
...
Perl::ToPerl6 does a lot of iterations over the PPI document tree via
...
L<Perl::ToPerl6::Document|Perl::ToPerl6::Document> will not have a filename.
This may cause L<Perl::ToPerl6::Document|Perl::ToPerl6::Document> to incorrectly
...
L<Perl::ToPerl6::Document|Perl::ToPerl6::Document> to have a particular
...
Perl::ToPerl6's subsequent analysis because some caches may fall out of
date.
...
this method will return two L<Perl::ToPerl6::Document|Perl::ToPerl6::Document>s
...
PPI::Document, the Perl::ToPerl6::Document class masquerades as the
PPI::Document class.
...
L<Perl::ToPerl6::Annotation|Perl::ToPerl6::Annotation>s that
...
L<Perl::ToPerl6::Transformation|Perl::ToPerl6::Transformation>s
