package Test::Perl::Mogrify::Enforcer;
...
sub all_policies_ok {
    ...
    for my $policy ( sort keys %{$subtests_with_extras} ) {
        ...
        my ($full_policy_name, $method) = ("Perl::Mogrify::Enforcer::$policy", 'violates');
...
Test::Perl::Mogrify::Enforcer - A framework for testing your custom Policies
...
=head1 SYNOPSIS
    ...
    # "perl -Ilib t/policy-test.t My::Enforcer".
...
L<Perl::Mogrify::Enforcer|Perl::Mogrify::Enforcer> modules.  Enforcer testing usually
